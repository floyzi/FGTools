...
namespace Discord
{
    ...
    public partial class ActivityManager
    {
        ...
        private static readonly List<GCHandle> _pinnedDelegates = new List<GCHandle>();

        public void UpdateActivity(Activity activity, UpdateActivityHandler callback)
        {
            GCHandle wrapped = GCHandle.Alloc(callback);
            var ffiCallback = new FFIMethods.UpdateActivityCallback(UpdateActivityCallbackImpl);
            _pinnedDelegates.Add(GCHandle.Alloc(ffiCallback));
            Methods.UpdateActivity(MethodsPtr, ref activity, GCHandle.ToIntPtr(wrapped), ffiCallback);
        }
